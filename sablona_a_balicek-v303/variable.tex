...
\hyphenation{sy-sté-mo-vých}
\hyphenation{lo-gi-cky}
\hyphenation{a-pli-ka-ci}
\hyphenation{stru-ktu-ra}
\hyphenation{činnosti}
\hyphenation{vy-sta-ven}
\hyphenation{PlanetLab}
...
% u obhajoby semestrální práce se oponent nezobrazuje M.Sc. Sara Ricci, Ph.D.
\oponent[M.Sc.]{Sara}{Ricci}[Ph.D.]

%% Název práce:
%  První parametr je název v originálním jazyce,
%  druhý je překlad v angličtině nebo češtině (pokud je originální jazyk angličtina)
\nazev{Aplikace pro monitorování serverů s~operačním systémem Linux}{Application for monitoring of Linux servers}
...
%% Rok obhajoby
\rok{2019}
\datum{5.\,6.\,2019} % Datum se uplatní pouze v prezentaci k obhajobě
...
%% Klíčová slova
\klicovaslova{%
Critical section, Linux, Multi-processing, PlanetLab Network, PlanetLab Server Manager, Python, Virtualization
}{%
Kritická sekce, Linux, Multi-processing, PlanetLab Server Manager, Python, Síť \mbox{PlanetLab}, Virtualizace
}
