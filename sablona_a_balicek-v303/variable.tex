...
Síť PlanetLab, PlanetLab Server Manager, Linux, Virtualizace, Multi-processing, Kritická sekce, Python
}

%% Poděkování
\podekovanitext{%
I~would like to thank my thesis advisor doc. Ing.~Dan Komosný~Ph.D.\ for his guidance, great leadership, time at consultations, patience and factual suggestions how to improve this work. Also, I~would like to thank to CESNET association which has provided the necessary infrastructure to make this thesis happen. Map data copyrighted OpenStreetMap contributors and available from \url{https://www.openstreetmap.org}.
}%
