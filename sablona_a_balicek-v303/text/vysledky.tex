...
\begin{figure}[H]
	\centering
	\scalebox{0.55}{\includegraphics{obrazky/plbmng_basic}}
...
\begin{figure}[H]
	...
	\caption{Map of nodes on world map using the PlanetLab Server Manager node database and map rendering functionality. Data from April 2019.}
	\label{fig:allnodes}
\end{figure}
