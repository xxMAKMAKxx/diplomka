...
\begin{figure}[H]
	...
	\caption{Displaying the countries on a world map using the PlanetLab Server Manager server database and map rendering functionality from April 2019.}
	\label{fig:allnodes}
\end{figure}
...
\begin{figure}[H]
	\centering
	\scalebox{1}{\includegraphics{obrazky/nodestats}}
	\caption{PlanetLab network node statistics by April 2019 from \texttt{cesnet\_utko} slice.}
	\label{fig:nodestats}
\end{figure}
...
\begin{figure}[H]
	\centering
	\scalebox{1}{\includegraphics{obrazky/sshcountriesgraph}}
	\caption{Servers accessible over SSH divided into countries.}
	\label{fig:sshcountriesgraph}
\end{figure}


\section{Testing Network Project with Planet Lab Server Manager}
